...
db.session.add(
    Student(
        ...
        primary_email = 'dude@obf.ateneo.edu',
        primary_mobile = '09999999999',
        secondary_email = 'get.trolled@im.so.funny.com',
...
db.session.add(
    Student(
        ...
        password = 'foobarfoo',
        primary_email = 'dood@obf.ateneo.edu',
        primary_mobile = '09999999991',
        secondary_email = 'get.nae.naed@im.so.funny.com',
